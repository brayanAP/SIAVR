        ...
        <section class="contenido">
            <div>
                <header>
                    ...
                    <script>
                        function Eliminar(){
                            var ventana = confirm("¿Quieres eliminar este menú?","");
                            return ventana;
                        }
                    </script>
                </header>
            ...
            <article>
                    <div class="contenedor">
                        <div class="barra-contenedor">
                            <p>Administración de menús</p>
                            <a href="nuevo_menu.html">Nuevo</a>
                        </div>
                                  ...
                                  <?php 
                                        ...
                                        while($contacto= $respuesta->fetch_assoc()){ 
                                            ...
                                            ?>
                                                ...
                                                <td><?php echo $contacto['fecha_actualizacion'] ?></td>
                                                ...
                                                <?php } ?>
                                                    <td><a href="form_mod_menu.php?id=<?php echo $contacto['id']; ?>"><i class="material-icons">mode_edit</i></a></td>
                                                    <td><a href="eliminar.php?id=<?php echo $contacto['id']; ?>&op=1" onclick="return Eliminar();"><i class="material-icons">delete</i></a></td>
                                                <?php if($estado == "DISPONIBLE"){?>
                                                    <td><a href="cambiar_estado.php?id=<?php echo $contacto['id']; ?>&op=1"><i class="material-icons">star</i></a></td>
                                                <?php }else{ ?>
                                                    <td><a href="cambiar_estado.php?id=<?php echo $contacto['id']; ?>&op=1"><i class="material-icons">star_border</i></a></td>
                                                <?php } ?>
                                                <td><a href="visualizar_menu.php?id=<?php echo $contacto['id']; ?>""><i class="material-icons">open_in_new</i></a></td>
                                            </tr>
                                        <?php } ?>      
