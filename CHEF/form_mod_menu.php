            ...
            <article>
                    <div class="contenedor">
                        ...
                        <div class="informacion" style="background-color: #b0bec5;">
                            ...
                            ?>
                                <form action="modificar.php?id=<?php echo $contacto['id']; ?>&op=1" method="post">
                                    <fieldset>
                                        <legend>Datos  menú</legend>
                                        <input type="text" value="<?php echo $contacto['nombre'];  ?>" name="nombre" placeholder="Nombre..." required="true">
