                                        ...
                                        while($contacto= $respuesta->fetch_assoc()){ 
                                            ...
                                            ?>
                                                ...
                                                <?php } ?>
                                                    ...
                                                    <td><a href="eliminar.php?id=<?php echo $contacto['id']; ?>&op=2" onclick="return Eliminar();"><i class="material-icons">delete</i></a></td>
                                                <?php if($estado == "DISPONIBLE"){?>
                                                ...
                                                <?php } ?>
                                                <td><a href="visualizar_platillo.php?id=<?php echo $contacto['id'];?>"><i class="material-icons">open_in_new</i></a></td>
                                            </tr>
                                        <?php } ?>      
                                  </tbody>
                                </table>
