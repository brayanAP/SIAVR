            ...
            <article>
                    <div class="contenedor">
                        <div class="barra-contenedor">
                            <p>Visualizar platillo</p>
                            <a href="platillos.php">Salir</a>
                        </div>
                            ...
                            <div class="formulario-nuevo">
                                <form action="">
                                    <fieldset style="height: 47vh;">
                                        ...
                                        <input type="text" name="nombre" value="<?php echo $platillo['nombre']; ?>" disabled="false">
                                        <textarea name="descripcion" rows="4" cols="50"
                                        style="width: 400px;height: 150px;display: block;font-size: 1.2em;margin: 0 auto;padding-left: 10px;padding-right: 10px; margin-top: 20px;border-radius: 10px;resize: none;text-align: justify;font-family: 'Source Sans Pro', sans-serif;" disabled="false"><?php echo $platillo['descripcion']; ?></textarea>
                           
                                        <input type="number" name="precio" value="<?php echo $platillo['precio'] ?>" disabled="false">
                                        ...
                                        <?php 
                                            ...
                                            <select name="tipo" disabled="false">
