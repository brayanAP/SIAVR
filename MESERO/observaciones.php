                                ...
                                <table>
                                  ...
                                  <tbody>
                                    <?php 
                                        ...
                                        $sql = "SELECT * FROM pedidos WHERE estado = 'E'";
                                        ...
                                        while($contacto= $respuesta->fetch_assoc()){
                                            ...
                                            ?>
                                                <td><?php echo $contacto['mesas_id'] ?></td>
                                                <?php if($estado == "ESPERA"){?>
                                                <td style="border-left: 4px solid red;"><?php echo $estado ?></td>
                                            <?php }  ?>
                                                <td><a href="observaciones2.php?pedido=<?php echo $contacto['id'] ?>"><i class="material-icons">open_in_new</i></a></td>
                                            </tr>
                                        <?php } ?>      
                                  </tbody>
                                </table>
